...
class Simulator_01():
    ...
    def __init__(self, simulation_start_dt, simulation_end_dt, db_info, is_first = False, data_start_date = pd.to_datetime('2022-01-01'), data_end_date = None, weight_학생숫자 = 1, 차량숫자 = 12, 시군구_ids = ['11220', '11230', '11240']):
        '''
